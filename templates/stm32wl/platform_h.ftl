...
[#assign Activate_BOARD_RESOURCES = ""]
    ...
    [#list SWIPdatas as SWIP]
        [#if SWIP.defines??]
            [#list SWIP.defines as definition]
                ...
                [/#if]
                [#if definition.name == "Activate_BOARD_RESOURCES"]
                    [#assign Activate_BOARD_RESOURCES = definition.value]
                [/#if]
...
[#if (Activate_RADIO_BOARD_INTERFACE =="Bsp")]
...
[#if ((CPUCORE != "CM0PLUS") && (Activate_BOARD_RESOURCES == "M4")) || ((CPUCORE == "CM0PLUS") && (Activate_BOARD_RESOURCES == "M0PLUS")) || (Activate_BOARD_RESOURCES == "both")]
