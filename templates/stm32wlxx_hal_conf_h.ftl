...
[#assign allModules = ["ADC", "COMP", "CRC", "AES", "DAC", "GTZC", "HSEM", "I2C", "I2S", "IPCC", "IRDA", "IWDG", "LPTIM", "PKA", "RNG", "RTC", "SMARTCARD", "SMBUS", "SPI", "SUBGHZ", "TIM", "UART", "USART", "WWDG"]]
  [#list allModules as module]
	[#if isModuleUsed(module) || (modules?contains("KMS") && (module=="AES" | module="PKA"))]
