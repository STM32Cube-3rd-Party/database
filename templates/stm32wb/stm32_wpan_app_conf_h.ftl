...
[#if (BT_SIG_BLOOD_PRESSURE_SENSOR = 1) || (BT_SIG_HEALTH_THERMOMETER_SENSOR = 1) || (BT_SIG_HEART_RATE_SENSOR = 1) || (CUSTOM_P2P_SERVER = 1) || (CUSTOM_P2P_ROUTER = 1) || (CUSTOM_TEMPLATE = 1) || (CUSTOM_P2P_CLIENT =1)]
/**
 ...
 */
#define CFG_BLE_OPTIONS  (${CFG_BLE_OPTIONS_LL} | ${CFG_BLE_OPTIONS_SVC} | ${CFG_BLE_OPTIONS_DEVICE_NAME} | ${CFG_BLE_OPTIONS_EXT_ADV} | ${CFG_BLE_OPTIONS_CS_ALGO} | ${CFG_BLE_OPTIONS_GATTDB_NVM} | ${CFG_BLE_OPTIONS_GATT_CACHING} | ${CFG_BLE_OPTIONS_POWER_CLASS})
 ...
 */
#define CFG_BLE_OPTIONS_EXT  (${CFG_BLE_OPTIONS_APPEARANCE} | ${CFG_BLE_OPTIONS_ENHANCED_ATT})
