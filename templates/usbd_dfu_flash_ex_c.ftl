...
[#if handleNameHS == "HS"]
static uint16_t FLASH_If_Init_HS(void);
static uint16_t FLASH_If_Erase_HS(uint32_t Add);
static uint16_t FLASH_If_Write_HS(uint8_t *src, uint8_t *dest, uint32_t Len);
static uint8_t *FLASH_If_Read_HS(uint8_t *src, uint8_t *dest, uint32_t Len);
static uint16_t FLASH_If_DeInit_HS(void);
static uint16_t FLASH_If_GetStatus_HS(uint32_t Add, uint8_t Cmd, uint8_t *buffer);
[/#if]
...
[#if handleNameHS == "HS"]
__ALIGN_BEGIN USBD_DFU_MediaTypeDef USBD_DFU_Flash_fops_HS __ALIGN_END =
{
    (uint8_t*)FLASH_DESC_STR,
    FLASH_If_Init_HS,
    FLASH_If_DeInit_HS,
...
/**
  ...
  * @retval USBD_OK if operation is successful, MAL_FAIL else.
  */
uint16_t FLASH_If_Init_HS(void)
{
  /* USER CODE BEGIN 6 */
  return (USBD_OK);
  /* USER CODE END 6 */
...
/**
  ...
  * @retval USBD_OK if operation is successful, MAL_FAIL else.
  */
uint16_t FLASH_If_DeInit_HS(void)
{
  /* USER CODE BEGIN 7 */
  return (USBD_OK);
  /* USER CODE END 7 */
...
/**
  ...
  * @retval USBD_OK if operation is successful, MAL_FAIL else.
  */
uint16_t FLASH_If_Erase_HS(uint32_t Add)
{
  /* USER CODE BEGIN 8 */
  return (USBD_OK);
  /* USER CODE END 8 */
...
/**
  ...
  * @retval USBD_OK if operation is successful, MAL_FAIL else.
  */
uint16_t FLASH_If_Write_HS(uint8_t *src, uint8_t *dest, uint32_t Len)
{
  /* USER CODE BEGIN 9 */
  return (USBD_OK);
  /* USER CODE END 9 */
...
/**
  ...
  * @retval Pointer to the physical address where data should be read.
  */
uint8_t *FLASH_If_Read_HS(uint8_t *src, uint8_t *dest, uint32_t Len)
{
  /* Return a valid address to avoid HardFault */
  /* USER CODE BEGIN 10 */
  return (uint8_t*)(FLASH_BASE);
...
/**
  ...
  */
uint16_t FLASH_If_GetStatus_HS(uint32_t Add, uint8_t Cmd, uint8_t *buffer)
{
  /* USER CODE BEGIN 11 */
  switch(Cmd)
  {
