...
[#if handleNameFS == "FS"]
[#include mxTmpFolder+"/usb_drd_fs_vars.tmp"]
[/#if]
...
[#include mxTmpFolder+"/usb_drd_fs_Msp.tmp"]
[/#if]
[/#if]
...
[#if FamilyName.contains("STM32F7") | FamilyName.contains("STM32G0")| FamilyName.contains("STM32F4") | FamilyName.contains("STM32H7") | FamilyName.contains("STM32F1") | FamilyName.contains("STM32F2")]
/**
...
#thhcd_USB_DRD_FS.pData = phost;
#tphost->pData = &hhcd_USB_DRD_FS;
[#include mxTmpFolder+"/usb_drd_fs_HalInit.tmp"]
#tUSBH_LL_SetTimer(phost, HAL_HCD_GetCurrentFrame(&hhcd_USB_DRD_FS));
#t}
[/#if]
  return USBH_OK;
}
