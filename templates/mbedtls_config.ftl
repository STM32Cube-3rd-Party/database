...
[#list SWIPdatas as SWIP]
	[#if SWIP.defines??]
		[#list SWIP.defines as definition]
			[#if definition.name="MBEDTLS_CHECK_PARAMS"]
/**
 ...
 */
            [#if definition.value="0"]
					[#lt]//#define MBEDTLS_CHECK_PARAMS
				[#else]
					[#lt]#define MBEDTLS_CHECK_PARAMS
				[/#if]
			[/#if]
...
[#list SWIPdatas as SWIP]
	[#if SWIP.defines??]
		[#list SWIP.defines as definition]
			[#if definition.name="MBEDTLS_REMOVE_3DES_CIPHERSUITES"]
/**
 ...
 */
            [#if definition.value="0"]
					[#lt]//#define MBEDTLS_REMOVE_3DES_CIPHERSUITES
				[#else]
					[#lt]#define MBEDTLS_REMOVE_3DES_CIPHERSUITES
				[/#if]
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_MPI_WINDOW_SIZE_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_MPI_WINDOW_SIZE"]
						...
						[#else]
							[#lt]#define MBEDTLS_MPI_WINDOW_SIZE            ${definition.value} /**< Maximum windows size used. */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_MPI_MAX_SIZE_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_MPI_MAX_SIZE"]
						...
						[#else]
							[#lt]#define MBEDTLS_MPI_MAX_SIZE            ${definition.value} /**< Maximum number of bytes for usable MPIs. */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_CTR_DRBG_ENTROPY_LEN_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_CTR_DRBG_ENTROPY_LEN"]
						...
						[#else]
							[#lt]#define MBEDTLS_CTR_DRBG_ENTROPY_LEN               ${definition.value} /**< Amount of entropy used per seed by default (48 with SHA-512, 32 with SHA-256) */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_CTR_DRBG_RESEED_INTERVAL_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_CTR_DRBG_RESEED_INTERVAL"]
						...
						[#else]
							[#lt]#define MBEDTLS_CTR_DRBG_RESEED_INTERVAL        ${definition.value} /**< Interval before reseed is performed by default */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_CTR_DRBG_MAX_INPUT_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_CTR_DRBG_MAX_INPUT"]
						...
						[#else]
							[#lt]#define MBEDTLS_CTR_DRBG_MAX_INPUT                ${definition.value} /**< Maximum number of additional input bytes */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_CTR_DRBG_MAX_REQUEST_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_CTR_DRBG_MAX_REQUEST"]
						...
						[#else]
							[#lt]#define MBEDTLS_CTR_DRBG_MAX_REQUEST             ${definition.value} /**< Maximum number of requested bytes per call */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_CTR_DRBG_MAX_SEED_INPUT_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_CTR_DRBG_MAX_SEED_INPUT"]
						...
						[#else]
							[#lt]#define MBEDTLS_CTR_DRBG_MAX_SEED_INPUT           ${definition.value} /**< Maximum size of (re)seed buffer */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_HMAC_DRBG_RESEED_INTERVAL_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_HMAC_DRBG_RESEED_INTERVAL"]
						...
						[#else]
							[#lt]#define MBEDTLS_HMAC_DRBG_RESEED_INTERVAL   ${definition.value} /**< Interval before reseed is performed by default */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_HMAC_DRBG_MAX_INPUT_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_HMAC_DRBG_MAX_INPUT"]
						...
						[#else]
							[#lt]#define MBEDTLS_HMAC_DRBG_MAX_INPUT           ${definition.value} /**< Maximum number of additional input bytes */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_HMAC_DRBG_MAX_REQUEST_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_HMAC_DRBG_MAX_REQUEST"]
						...
						[#else]
							[#lt]#define MBEDTLS_HMAC_DRBG_MAX_REQUEST        ${definition.value} /**< Maximum number of requested bytes per call */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_HMAC_DRBG_MAX_SEED_INPUT_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_HMAC_DRBG_MAX_SEED_INPUT"]
						...
						[#else]
							[#lt]#define MBEDTLS_HMAC_DRBG_MAX_SEED_INPUT      ${definition.value} /**< Maximum size of (re)seed buffer */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_ECP_MAX_BITS_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_ECP_MAX_BITS"]
						...
						[#else]
							[#lt]#define MBEDTLS_ECP_MAX_BITS             ${definition.value} /**< Maximum bit size of groups */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_ECP_WINDOW_SIZE_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_ECP_WINDOW_SIZE"]
						...
						[#else]
							[#lt]#define MBEDTLS_ECP_WINDOW_SIZE            ${definition.value} /**< Maximum window size used */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_ECP_FIXED_POINT_OPTIM_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_ECP_FIXED_POINT_OPTIM"]
						...
						[#else]
							[#lt]#define MBEDTLS_ECP_FIXED_POINT_OPTIM      ${definition.value} /**< Enable fixed-point speed-up */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_ENTROPY_MAX_SOURCES_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_ENTROPY_MAX_SOURCES"]
						...
						[#else]
							[#lt]#define MBEDTLS_ENTROPY_MAX_SOURCES                ${definition.value} /**< Maximum number of sources supported */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_ENTROPY_MAX_GATHER_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_ENTROPY_MAX_GATHER"]
						...
						[#else]
							[#lt]#define MBEDTLS_ENTROPY_MAX_GATHER                ${definition.value} /**< Maximum amount requested from entropy sources */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_ENTROPY_MIN_HARDWARE_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_ENTROPY_MIN_HARDWARE"]
						...
						[#else]
							[#lt]#define MBEDTLS_ENTROPY_MIN_HARDWARE               ${definition.value} /**< Default minimum number of bytes required for the hardware entropy source mbedtls_hardware_poll() before entropy is released */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_MEMORY_ALIGN_MULTIPLE_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_MEMORY_ALIGN_MULTIPLE"]
						...
						[#else]
							[#lt]#define MBEDTLS_MEMORY_ALIGN_MULTIPLE      ${definition.value} /**< Align on multiples of this value */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_PLATFORM_STD_MEM_HDR_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_PLATFORM_STD_MEM_HDR"]
						...
						[#else]
							[#lt]#define MBEDTLS_PLATFORM_STD_MEM_HDR   ${definition.value} /**< Header to include if MBEDTLS_PLATFORM_NO_STD_FUNCTIONS is defined. Don't define if no header is needed. */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_PLATFORM_STD_CALLOC_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_PLATFORM_STD_CALLOC"]
						...
						[#else]
							[#lt]#define MBEDTLS_PLATFORM_STD_CALLOC        ${definition.value} /**< Default allocator to use, can be undefined */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_PLATFORM_STD_FREE_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_PLATFORM_STD_FREE"]
						...
						[#else]
							[#lt]#define MBEDTLS_PLATFORM_STD_FREE            ${definition.value} /**< Default free to use, can be undefined */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_PLATFORM_STD_EXIT_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_PLATFORM_STD_EXIT"]
						...
						[#else]
							[#lt]#define MBEDTLS_PLATFORM_STD_EXIT            ${definition.value} /**< Default exit to use, can be undefined */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_PLATFORM_STD_TIME_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_PLATFORM_STD_TIME"]
						...
						[#else]
							[#lt]#define MBEDTLS_PLATFORM_STD_TIME            ${definition.value} /**< Default time to use, can be undefined. MBEDTLS_HAVE_TIME must be enabled */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_PLATFORM_STD_FPRINTF_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_PLATFORM_STD_FPRINTF"]
						...
						[#else]
							[#lt]#define MBEDTLS_PLATFORM_STD_FPRINTF      ${definition.value} /**< Default fprintf to use, can be undefined */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_PLATFORM_STD_PRINTF_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_PLATFORM_STD_PRINTF"]
						...
						[#else]
							[#lt]#define MBEDTLS_PLATFORM_STD_PRINTF        ${definition.value} /**< Default printf to use, can be undefined */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_PLATFORM_STD_SNPRINTF_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_PLATFORM_STD_SNPRINTF"]
						...
						[#else]
							[#lt]#define MBEDTLS_PLATFORM_STD_SNPRINTF    ${definition.value} /**< Default snprintf to use, can be undefined */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_PLATFORM_STD_EXIT_SUCCESS_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_PLATFORM_STD_EXIT_SUCCESS"]
						...
						[#else]
							[#lt]#define MBEDTLS_PLATFORM_STD_EXIT_SUCCESS       ${definition.value} /**< Default exit value to use, can be undefined */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_PLATFORM_STD_EXIT_FAILURE_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_PLATFORM_STD_EXIT_FAILURE"]
						...
						[#else]
							[#lt]#define MBEDTLS_PLATFORM_STD_EXIT_FAILURE       ${definition.value} /**< Default exit value to use, can be undefined */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_PLATFORM_STD_NV_SEED_READ_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_PLATFORM_STD_NV_SEED_READ"]
						...
						[#else]
							[#lt]#define MBEDTLS_PLATFORM_STD_NV_SEED_READ   ${definition.value} /**< Default nv_seed_read function to use, can be undefined */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_PLATFORM_STD_NV_SEED_WRITE_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_PLATFORM_STD_NV_SEED_WRITE"]
						...
						[#else]
							[#lt]#define MBEDTLS_PLATFORM_STD_NV_SEED_WRITE  ${definition.value} /**< Default nv_seed_write function to use, can be undefined */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_PLATFORM_STD_NV_SEED_FILE_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_PLATFORM_STD_NV_SEED_FILE"]
						...
						[#else]
							[#lt]#define MBEDTLS_PLATFORM_STD_NV_SEED_FILE  ${definition.value} /**< Seed file to read/write with default implementation */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_PLATFORM_CALLOC_MACRO_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_PLATFORM_CALLOC_MACRO"]
						...
						[#else]
							[#lt]#define MBEDTLS_PLATFORM_CALLOC_MACRO        ${definition.value} /**< Default allocator macro to use, can be undefined */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_PLATFORM_FREE_MACRO_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_PLATFORM_FREE_MACRO"]
						...
						[#else]
							[#lt]#define MBEDTLS_PLATFORM_FREE_MACRO            ${definition.value} /**< Default free macro to use, can be undefined */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_PLATFORM_EXIT_MACRO_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_PLATFORM_EXIT_MACRO"]
						...
						[#else]
							[#lt]#define MBEDTLS_PLATFORM_EXIT_MACRO            ${definition.value} /**< Default exit macro to use, can be undefined */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_PLATFORM_TIME_MACRO_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_PLATFORM_TIME_MACRO"]
						...
						[#else]
							[#lt]#define MBEDTLS_PLATFORM_TIME_MACRO            ${definition.value} /**< Default time macro to use, can be undefined. MBEDTLS_HAVE_TIME must be enabled */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_PLATFORM_TIME_TYPE_MACRO_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_PLATFORM_TIME_TYPE_MACRO"]
						...
						[#else]
							[#lt]#define MBEDTLS_PLATFORM_TIME_TYPE_MACRO       ${definition.value} /**< Default time macro to use, can be undefined. MBEDTLS_HAVE_TIME must be enabled */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_PLATFORM_FPRINTF_MACRO_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_PLATFORM_FPRINTF_MACRO"]
						...
						[#else]
							[#lt]#define MBEDTLS_PLATFORM_FPRINTF_MACRO      ${definition.value} /**< Default fprintf macro to use, can be undefined */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_PLATFORM_PRINTF_MACRO_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_PLATFORM_PRINTF_MACRO"]
						...
						[#else]
							[#lt]#define MBEDTLS_PLATFORM_PRINTF_MACRO        ${definition.value} /**< Default printf macro to use, can be undefined */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_PLATFORM_SNPRINTF_MACRO_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_PLATFORM_SNPRINTF_MACRO"]
						...
						[#else]
							[#lt]#define MBEDTLS_PLATFORM_SNPRINTF_MACRO    ${definition.value} /**< Default snprintf macro to use, can be undefined */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_PLATFORM_NV_SEED_READ_MACRO_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_PLATFORM_NV_SEED_READ_MACRO"]
						...
						[#else]
							[#lt]#define MBEDTLS_PLATFORM_NV_SEED_READ_MACRO   ${definition.value} /**< Default nv_seed_read function to use, can be undefined */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_PLATFORM_NV_SEED_WRITE_MACRO_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_PLATFORM_NV_SEED_WRITE_MACRO"]
						...
						[#else]
							[#lt]#define MBEDTLS_PLATFORM_NV_SEED_WRITE_MACRO  ${definition.value} /**< Default nv_seed_write function to use, can be undefined */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
...
[#list SWIPdatas as SWIP]
	[#if SWIP.defines??]
		[#list SWIP.defines as enableFlag]
			[#if enableFlag.name="MBEDTLS_PARAM_FAILED_ENABLE"]
 ...
 */
[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_PARAM_FAILED"]
						[#if enableFlag.value="0"]
							[#lt]//#define MBEDTLS_PARAM_FAILED( cond )               assert( cond )
						[#else]
							[#lt]#define MBEDTLS_PARAM_FAILED(${definition.value})               assert( ${definition.value} )
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_SSL_CACHE_DEFAULT_MAX_ENTRIES_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_SSL_CACHE_DEFAULT_MAX_ENTRIES"]
						...
						[#else]
							[#lt]#define MBEDTLS_SSL_CACHE_DEFAULT_MAX_ENTRIES      ${definition.value} /**< Maximum entries in cache */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_SSL_DEFAULT_TICKET_LIFETIME_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_SSL_DEFAULT_TICKET_LIFETIME"]
						...
						[#else]
							[#lt]#define MBEDTLS_SSL_DEFAULT_TICKET_LIFETIME     ${definition.value} /**< Lifetime of session tickets (if enabled) */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_PSK_MAX_LEN_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_PSK_MAX_LEN"]
						...
						[#else]
							[#lt]#define MBEDTLS_PSK_MAX_LEN               ${definition.value} /**< Max size of TLS pre-shared keys, in bytes (default 256 bits) */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_SSL_COOKIE_TIMEOUT_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_SSL_COOKIE_TIMEOUT"]
						...
						[#else]
							[#lt]#define MBEDTLS_SSL_COOKIE_TIMEOUT        ${definition.value} /**< Default expiration delay of DTLS cookies, in seconds if HAVE_TIME, or in number of cookies issued */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_X509_MAX_INTERMEDIATE_CA_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_X509_MAX_INTERMEDIATE_CA"]
						...
						[#else]
							[#lt]#define MBEDTLS_X509_MAX_INTERMEDIATE_CA   ${definition.value}   /**< Maximum number of intermediate CAs in a verification chain. */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
			...
			[#if enableFlag.name="MBEDTLS_X509_MAX_FILE_PATH_LEN_ENABLE"]
				[#list SWIP.defines as definition]
					[#if definition.name="MBEDTLS_X509_MAX_FILE_PATH_LEN"]
						...
						[#else]
							[#lt]#define MBEDTLS_X509_MAX_FILE_PATH_LEN     ${definition.value} /**< Maximum length of a path/filename string in bytes including the null terminator character ('\0'). */
						[/#if]
					[/#if]
				[/#list]			
			[/#if]
