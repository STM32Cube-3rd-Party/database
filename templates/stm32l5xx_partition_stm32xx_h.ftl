...
//   <o.1>  PVD_PVM_IRQn        [#if enabledIT?contains("PVD_PVM_IRQn")]<1=> Non-Secure state[#assign nonSecureIT0 = nonSecureIT0+", "+"1"/][#else]<0=> Secure state[/#if]
...
//   <o.5>  TAMP_S_IRQn         [#if enabledIT?contains("TAMP_S_IRQn")]<1=> Non-Secure state[#assign nonSecureIT0 = nonSecureIT0+", "+"5"/][#else]<0=> Secure state[/#if]
...
//   <o.27> DMAMUX1_IRQn        [#if enabledIT?contains("DMAMUX1_IRQn")]<1=> Non-Secure state[#assign nonSecureIT0 = nonSecureIT0+", "+"27"/][#else]<0=> Secure state[/#if]
//   <o.28> DMAMUX1_S_IRQn      [#if enabledIT?contains("DMAMUX1_S_IRQn")]<1=> Non-Secure state[#assign nonSecureIT0 = nonSecureIT0+", "+"28"/][#else]<0=> Secure state[/#if]
//   <o.29> DMA1_Channel1_IRQn  [#if enabledIT?contains("DMA1_Channel1_IRQn")]<1=> Non-Secure state[#assign nonSecureIT0 = nonSecureIT0+", "+"29"/][#else]<0=> Secure state[/#if]
...
/*
/ Interrupts 32..63
//   <o.0>  DMA1_Channel4_IRQn  [#if enabledIT?contains("DMA1_Channel4_IRQn")]<1=> Non-Secure state[#assign nonSecureIT1 = nonSecureIT1+", "+"0"/][#else]<0=> Secure state[/#if]
//   <o.1>  DMA1_Channel5_IRQn  [#if enabledIT?contains("MA1_Channel5_IRQ")]<1=> Non-Secure state[#assign nonSecureIT1 = nonSecureIT1+", "+"1"/][#else]<0=> Secure state[/#if]
//   <o.2>  DMA1_Channel6_IRQn  [#if enabledIT?contains("DMA1_Channel6_IRQn")]<1=> Non-Secure state[#assign nonSecureIT1 = nonSecureIT1+", "+"2"/][#else]<0=> Secure state[/#if]
//   <o.3>  DMA1_Channel7_IRQn  [#if enabledIT?contains("DMA1_Channel7_IRQn")]<1=> Non-Secure state[#assign nonSecureIT1 = nonSecureIT1+", "+"3"/][#else]<0=> Secure state[/#if]
//   <o.4>  DMA1_Channel8_IRQn  [#if enabledIT?contains("DMA1_Channel8_IRQn")]<1=> Non-Secure state[#assign nonSecureIT1 = nonSecureIT1+", "+"4"/][#else]<0=> Secure state[/#if]
//   <o.5>  ADC1_2_IRQn   	[#if enabledIT?contains("ADC1_2_IRQn")]<1=> Non-Secure state[#assign nonSecureIT1 = nonSecureIT1+", "+"5"/][#else]<0=> Secure state[/#if]
//   <o.6>  DAC_IRQn            [#if enabledIT?contains("DAC_IRQn")]<1=> Non-Secure state[#assign nonSecureIT1 = nonSecureIT1+", "+"6"/][#else]<0=> Secure state[/#if]
...
//   <o.9>  USB_FS_IRQn         [#if enabledIT?contains("USB_FS_IRQn")]<1=> Non-Secure state[#assign nonSecureIT2 = nonSecureIT2+", "+"9"/][#else]<0=> Secure state[/#if]
...
//   <o.13> Reserved            [#if enabledIT?contains("Reserved")]<1=> Non-Secure state[#assign nonSecureIT2 = nonSecureIT2+", "+"13"/][#else]<0=> Secure state[/#if]
...
//   <o.15> Reserved            [#if enabledIT?contains("Reserved")]<1=> Non-Secure state[#assign nonSecureIT2 = nonSecureIT2+", "+"15"/][#else]<0=> Secure state[/#if]
//   <o.16> DMA2_Channel1_IRQn  [#if enabledIT?contains("DMA2_Channel1_IRQn")]<1=> Non-Secure state[#assign nonSecureIT2 = nonSecureIT2+", "+"16"/][#else]<0=> Secure state[/#if]
//   <o.17> DMA2_Channel2_IRQn  [#if enabledIT?contains("DMA2_Channel2_IRQn")]<1=> Non-Secure state[#assign nonSecureIT2 = nonSecureIT2+", "+"17"/][#else]<0=> Secure state[/#if]
//   <o.18> DMA2_Channel3_IRQn  [#if enabledIT?contains("DMA2_Channel3_IRQn")]<1=> Non-Secure state[#assign nonSecureIT2 = nonSecureIT2+", "+"18"/][#else]<0=> Secure state[/#if]
//   <o.19> DMA2_Channel4_IRQn  [#if enabledIT?contains("DMA2_Channel4_IRQn")]<1=> Non-Secure state[#assign nonSecureIT2 = nonSecureIT2+", "+"19"/][#else]<0=> Secure state[/#if]
//   <o.20> DMA2_Channel5_IRQn  [#if enabledIT?contains("DMA2_Channel5_IRQn")]<1=> Non-Secure state[#assign nonSecureIT2 = nonSecureIT2+", "+"20"/][#else]<0=> Secure state[/#if]
//   <o.21> DMA2_Channel6_IRQn  [#if enabledIT?contains("DMA2_Channel6_IRQn")]<1=> Non-Secure state[#assign nonSecureIT2 = nonSecureIT2+", "+"21"/][#else]<0=> Secure state[/#if]
//   <o.22> DMA2_Channel7_IRQn  [#if enabledIT?contains("DMA2_Channel7_IRQn")]<1=> Non-Secure state[#assign nonSecureIT2 = nonSecureIT2+", "+"22"/][#else]<0=> Secure state[/#if]
//   <o.23> DMA2_Channel8_IRQn  [#if enabledIT?contains("DMA2_Channel8_IRQn")]<1=> Non-Secure state[#assign nonSecureIT2 = nonSecureIT2+", "+"23"/][#else]<0=> Secure state[/#if]
...
//   <o.4>  I2C4_EV_IRQn        [#if enabledIT?contains("I2C4_EV_IRQn")]<1=> Non-Secure state[#assign nonSecureIT3 = nonSecureIT3+", "+"4"/][#else]<0=> Secure state[/#if]
//   <o.5>  I2C4_ER_IRQn        [#if enabledIT?contains("I2C4_ER_IRQn")]<1=> Non-Secure state[#assign nonSecureIT3 = nonSecureIT3+", "+"5"/][#else]<0=> Secure state[/#if]
//   <o.6>  DFSDM1_FLT0_IRQn    [#if enabledIT?contains("DFSDM1_FLT0_IRQn")]<1=> Non-Secure state[#assign nonSecureIT3 = nonSecureIT3+", "+"6"/][#else]<0=> Secure state[/#if]
//   <o.7>  DFSDM1_FLT1_IRQn    [#if enabledIT?contains("DFSDM1_FLT1_IRQn")]<1=> Non-Secure state[#assign nonSecureIT3 = nonSecureIT3+", "+"7"/][#else]<0=> Secure state[/#if]
//   <o.8>  DFSDM1_FLT2_IRQn    [#if enabledIT?contains("DFSDM1_FLT2_IRQn")]<1=> Non-Secure state[#assign nonSecureIT3 = nonSecureIT3+", "+"8"/][#else]<0=> Secure state[/#if]
//   <o.9>  DFSDM1_FLT3_IRQn    [#if enabledIT?contains("DFSDM1_FLT3_IRQn")]<1=> Non-Secure state[#assign nonSecureIT3 = nonSecureIT3+", "+"9"/][#else]<0=> Secure state[/#if]
