...
/**
  ******************************************************************************
  * @file    ${Board_RPN?lower_case}_radio.c
  * @author  MCD Application Team
  * @brief   This file provides set of firmware functions to manage:
  *          - RF circuitry available on ${Board_RPN}
...
/** @addtogroup ${BoardName?upper_case}_RADIO_LOW_LEVEL
  * @brief This file provides set of firmware functions to Radio switch 
  *        available on ${BoardName?upper_case} Kit from STMicroelectronics.
  * @{
  */

/** @addtogroup ${BoardName?upper_case}_RADIO_LOW_LEVEL_Exported_Functions
  * @{
  */
