...
#define UCPDDMA_INSTANCE0_REQUEST_RX   LL_${USBPD_PORT0_DMA_RX}_REQUEST_${USBPD_PORT0_DMA_REQUEST_RX}
...
#define UCPDDMA_INSTANCE0_REQUEST_TX   LL_${USBPD_PORT0_DMA_TX}_REQUEST_${USBPD_PORT0_DMA_REQUEST_TX}
