...
/**
  ...
  */
  ...
  #define HSE_VALUE    [#if hse_value??]${hse_value}[#else]16000000[/#if]UL /*!< Value of the External oscillator in Hz */
#endif /* HSE_VALUE */

#if !defined  (HSE_STARTUP_TIMEOUT)
  #define HSE_STARTUP_TIMEOUT    [#if HSE_Timout??]${HSE_Timout}[#if HSE_Timout?matches("(0x[0-9]*[a-f]*[A-F]*)|([0-9]*)")]UL[/#if][#else]100UL[/#if]   /*!< Time out for HSE start up, in ms */
...
/**
  ...
  */
  ...
  #define MSI_VALUE    [#if msi_value??]${msi_value}[#else]4000000[/#if]UL /*!< Value of the Internal oscillator in Hz*/
#endif /* MSI_VALUE */
...
/**
  ...
  */
  ...
  #define EXTERNAL_SAI2_CLOCK_VALUE    [#if sai2_value??]${sai2_value}[#else]48000[/#if]UL /*!< Value of the SAI2 External clock source in Hz*/
